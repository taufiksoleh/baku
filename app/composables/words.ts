...
export const KATA_DATA: KataItem[] = [
  // === UMUM ===
...
export const KATEGORI_LIST = ['Semua', ...new Set(KATA_DATA.map(item => item.kategori))]

export function getKataByKategori(kategori: string): KataItem[] {
